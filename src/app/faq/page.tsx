...
export default function FAQPage() {
  ...
  const commonQuestions = [
        ...
        {
          question: "Does IILM University have an early decision application process?",
          answer:
  ...
  const [expandedQuestion, setExpandedQuestion] = useState<{ categoryIndex: number; questionIndex: number } | null>(null);
  ...
  return (
    <div className="bg-blue-50">
      ...
      <header className="container mx-auto p-6 text-center">
        <h1 className="text-4xl font-bold text-blue-900 mb-4">FAQs and Common Questions</h1>
        <p className="text-lg text-gray-700">
          Find answers to frequently asked questions about IILM University's admissions, financial aid, and more.
        </p>
      </header>
      ...
      <section className="container mx-auto p-6 space-y-8">
        {faqs.map((faqCategory, categoryIndex) => (
          <div key={categoryIndex} className="space-y-4">
            <h2 className="text-2xl font-bold text-blue-800 mb-4">{faqCategory.category}</h2>
      ...
      <section className="container mx-auto p-6 space-y-8">
        <h2 className="text-2xl font-bold text-blue-800 mb-4">Common Questions</h2>
        {commonQuestions.map((item, index) => (
          ...
          >
            ...
            >
              <h3 className="text-xl font-bold text-blue-800">{item.question}</h3>
              <span className="text-blue-600 text-2xl">
                {expandedQuestion && expandedQuestion.questionIndex === index && expandedQuestion.categoryIndex === index
                  ? "−"
                  : "+"}
              </span>
            </button>
